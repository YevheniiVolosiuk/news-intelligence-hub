  ...
  const checkboxTableData: ProjectData[] = [
    {
      ...
      progress: 60,
      progressColor: '**:data-[slot=progress-indicator]:bg-warning',
    },
    {
    ...
    },
    {
      ...
      handle: 'steele@ui.com',
      progress: 37,
      progressColor: '**:data-[slot=progress-indicator]:bg-destructive',
    },
    {
      ...
      handle: 'olivia@ui.com',
      progress: 87,
      progressColor: '**:data-[slot=progress-indicator]:bg-success',
    },
    {
      project: 'Digital Marketing',
      date: '15 April 2026',
              ...
              {checkboxTableData.map((item, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="whitespace-nowrap p-3 ps-6">
                    <Checkbox className="data-[state=checked]:bg-primary data-[state=checked]:border-primary cursor-pointer" />
                  </TableCell>
